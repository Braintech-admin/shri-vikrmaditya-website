    ...
    <main className="min-h-screen bg-[#f5f7fa] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          {/* Header */}
          <div className="bg-[#071d49] px-6 py-8 text-center">
          ...
          <div className="px-6 py-7 sm:px-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-[#071d49] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#123b7a] disabled:cursor-not-allowed disabled:opacity-60"
              >
        ...
        <p className="mt-5 text-center text-xs text-gray-400">
          © {new Date().getFullYear()} Shri Vikramaditya Inter College
        </p>
      </div>
    </main>
  );
